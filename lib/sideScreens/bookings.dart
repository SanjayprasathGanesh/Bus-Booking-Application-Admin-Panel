...
import 'package:redbus_admin/sideScreens/cancelledBookings.dart';

class Bookings extends StatefulWidget {
  String? busId;
  Bookings({Key? key, required this.busId}) : super(key: key);
...
class _BookingsState extends State<Bookings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Bookings",style:
        TextStyle(
            fontSize: 18.0,
        ...
        child: Column(
          children: [
            Container(
              ...
              child: FutureBuilder(
                future: databaseConnection.getBookings(widget.busId!),
      ...
      floatingActionButton: FloatingActionButton(
          tooltip: 'Cancelled Tickets',
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context) => CancelledBookings(busId: widget.busId)));
          },
          child: const Icon(Icons.cancel_outlined,size: 30.0,),
      ),
    );
  }
}
